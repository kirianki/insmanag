...
export interface Renewal { id: string; customer: string; customer_name: string; created_by: UserNested; current_insurer: string; policy_type_description: string; vehicle_registration_number?: string; renewal_date: string; premium_estimate?: string; notes?: string; }
